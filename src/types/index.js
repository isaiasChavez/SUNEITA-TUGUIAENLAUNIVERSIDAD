...
export const OBTENER_IMAGENES_RENTA = "OBTENER_IMAGENES_RENTA";

//TYPES PARA AUTENTICACION
...
//TYPES PARA LOS DATOS DE LAS RENTAS
...
export const BIMESTRE = "bimestre";
export const TRIMESTRE = "trimestre";
export const SEMESTRE = "semestre";
export const ANUAL = "anual";
export const SIN_CONTRATO = "sin contrato";
...
export const AGREGAR_BAZAR = "AGREGAR_BAZAR";
export const ELIMINAR_PRODUCTO_BAZAR = "ELIMINAR_PRODUCTO_BAZAR";
export const SELECCIONAR_PRODUCTO_BAZAR = "SELECCIONAR_PRODUCTO_BAZAR ";
export const LIMPIAR_PRODUCTO_BAZAR = " LIMPIAR_PRODUCTO_BAZAR";
export const OBTENER_PRODUCTOS_BAZAR = "OBTENER_PRODUCTOS_BAZAR ";
export const OBTENER_PRODUCTOS_CATEGORIA = "OBTENER_PRODUCTOS_CATEGORIA ";
export const PRODUCTO_BAZAR_ACTUAL = " PRODUCTO_BAZAR_ACTUAL";
export const VALIDAR_PRODUCTO = "VALIDAR_PRODUCTO ";
export const OBTENER_PRODUCTOS_BAZAR_USUARIO =
  "OBTENER_PRODUCTOS_BAZAR_USUARIO ";
export const PAUSAR_PRODUCTO = "PAUSAR_PRODUCTO";
